 ...
 * @notice Tests for LockToken deposit and mint functionality with 1:1 conversion guarantee
 */
contract LockTokenDepositTest is LockTokenBaseTest {
    // ========================================
     ...
     * @dev In a normal ERC4626, this could dilute future deposits but LockToken
    ...
    function test_InflationAttack_CannotStealDeposits(uint256 victimDeposit) public {
        ...
        assertEq(lockToken.totalSupply(), 0, "LockToken should have no supply");
